...
class AmazonBotPipeline:
    ...
    def spider_opened(self, spider):
        ...
        self.exporter.fields_to_export = ['name', 'price', 'asin', 'seller', 'categoria', 'rank', 'valoracion_media', 'busqueda', 'marketplace','start_date']#Estos son los campos que vamos a usar para guardar los datos
